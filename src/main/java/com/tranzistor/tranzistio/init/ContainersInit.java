...
public class ContainersInit {
	...
	public static final RegistryObject<ContainerType<CokeOvenContainer>> COKE_OVEN = CONTAINERS.register("coke_oven_container", () -> IForgeContainerType.create(CokeOvenContainer::new));
}
